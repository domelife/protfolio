$(document).ready(function(){
    ...
    // .obj11 {left: -200px; bottom: -100px;}
    // .obj21 {left: -100px; top: -100px;}
    // .obj31 {left: 100px; bottom: 200px;}
    // .obj41 {left: 350px; bottom: -150px;}
    // .obj51 {left: -100px; bottom: -300px;}

    $('.obj11').css({'left': -200+(x/50)+'px', 'bottom': -100+(x/-150)+'px'})
    $('.obj21').css({'left': -100+(x/80)+'px', 'bottom': -100+(x/-180)+'px'})
    $('.obj31').css({'left': 100+(x/20)+'px', 'bottom': 200+(x/250)+'px'})
    $('.obj41').css({'left': 350+(x/70)+'px', 'bottom': -150+(x/50)+'px'})
    $('.obj51').css({'left': -100+(x/30)+'px', 'bottom': -300+(x/20)+'px'})
